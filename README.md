...
There is a shortage of high-quality thinking on:
- Making AI reliable in production
- Scaling systems without losing sanity
- Designing databases and distributed systems properly
- Engineering for second-order effects

This repository is my curated collection of production-grade engineering wisdom which is updated frequently based on what all I come across online (in no particular order).
...
- [Awesome Agentic Reasoning Papers](https://github.com/weitianxin/Awesome-Agentic-Reasoning?tab=readme-ov-file#-agentic-memory)
...
- [Maxpool - Evolution of LLM Reasoning](https://maxpool.dev/research-papers/llm_reasoning_timeline.html)
- [Why LLMs Hallucinate?](https://galileo.ai/blog/why-language-models-hallucinate)
...
- [LLM Strawberrt (OpenAI o1](https://github.com/hijkzzz/Awesome-LLM-Strawberry)
...
- [How VLLM Inference Engine Works](https://www.youtube.com/watch?v=QyHHbeXqgrQ)
- [LLM Optimization Notes: Memory, Compute & Inference Techniques](https://gaurigupta19.github.io/blogs/llm-optimization)
- [Galileo - Deep Dive into Context Engineering for Agents](https://galileo.ai/blog/context-engineering-for-agents)
...
- [Layout Aware Document Translation](https://github.com/PDFMathTranslate/PDFMathTranslate?tab=readme-ov-file)
- [Presidio - Data Protection and De-identification SDK](https://github.com/microsoft/presidio)
